...
base:{
	16:{
		attr:{x:0,	y:42,	width:63,	height:40,class:"special"},
		data:[{x:15,y:25,class:"key",text:"Esc"}]
	},
	17:{
...
function CreateKeyboard(design,layout,layer,theme){
	...
	let x=PrintKeyContent({...(design=="40"?mlayouts.base:{...mlayouts.base,...mlayouts.k60}),...mlayouts[layout],...(layout=="JIS"?{...mlayouts.bottom,...mlayouts.bottomJIS}:mlayouts.bottom)},layers[layer]);
